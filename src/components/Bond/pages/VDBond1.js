...
export default function VDBond1({name, sn, city, state, zipcode/*address*/, date, setDateVD, date2}) {
    return (
            ...
            <table style={{"margin-left": "auto", "margin-right": "auto"}}>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <Input width="200px" className="text-center fw-bold" maxlength="20"/>
                        </td>
                        <td className="text-end">
                            SSN: XXX-XX-
                        </td>
                    ...
                    <tr>
                        ...
                        <td className="pt-5">
                            <Input width="200px" className="text-center fw-bold" maxlength="4"/>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <Input width="200px" className="text-center fw-bold" maxlength="25"/>
                        </td>
                        <td>
                            &nbsp;
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <Input width="200px" className="text-center fw-bold" maxlength="15"/>
                        </td>
                        <td className="text-end">
                            Term:
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <Input className="min-w text-center fw-bold" maxlength="17"/>
                        </td>
                    </tr>
                    <tr>
